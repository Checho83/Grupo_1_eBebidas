...
const productController = {
   view: (req,res)=>{
      res.render('productos/productDetail',{productos: products});
   },
	create: (req, res) => {
	...
	store: (req, res) => {
		...
		let nuevoProducto =  {
			...
			// this.detail : req.body.detail,
			 description : req.body.description,
			 image : req.file.originalname
		 }
		 
//		 console.log(nuevoProducto);	
		 let productos = products.push(nuevoProducto);
	...
	//	indexProducto.detail = req.body.detail;
